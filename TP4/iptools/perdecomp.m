...
% v1.0 (01/2014): initial Matlab version from perdecomp.sci v1.2
  ...
  % fourier de l'opérateur derivé seconde discrete en x et y. repmat (pour fx par exemple )est utilisée pour repliquer la
  % la ligne (cos(2*pi*(X-1)/nx)) ny fois ou X est definie ci dessus. ainsi
  % (fx+fy) est la transformé de fourier de l'opérateur laplacien discret.
